...
class TicketMessage(Base):
    ...
    # Delivery tracking - whether bot has delivered this message to the user
    bot_delivered: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False, server_default="0")
