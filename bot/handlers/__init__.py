...
from bot.handlers import admin, in_house, pre_arrival, room_service, start, additional_services, feedback, admin_panel, booking, guide, weather, sos, loyalty, staff, check_in
